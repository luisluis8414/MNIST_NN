...
public:
    ...
    Perceptron() : m_bias(0.0), m_learningRate(0.1) {}
    ...
    void save(std::ofstream &ofs) const
    {
        ...
        // Save weights
        ofs.write(reinterpret_cast<const char *>(m_weights.data()),
                  size * sizeof(double));
        // Save bias and learning rate
        ofs.write(reinterpret_cast<const char *>(&m_bias), sizeof(m_bias));
        ofs.write(reinterpret_cast<const char *>(&m_learningRate),
                  sizeof(m_learningRate));
    }
    ...
    void load(std::ifstream &ifs)
    {
        ...
        ifs.read(reinterpret_cast<char *>(m_weights.data()),
                 size * sizeof(double));
